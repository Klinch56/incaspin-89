...
function say(text,tone){commsEl.textContent=text;commsEl.classList.remove("st-comms-good","st-comms-bad");if(tone==="good"){commsEl.classList.add("st-comms-good-0cfce968");}
if(tone==="bad"){commsEl.classList.add("st-comms-bad-0cfce968");}}
...
function logFlight(value,won){var li=document.createElement("li");li.className="st-log-entry-0cfce968"+
